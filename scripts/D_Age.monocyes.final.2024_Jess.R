...
FC.1.5 <- subset(adult.up, State_AdultFC > state.threshold)
#73 genes which with a P-value <0.001

adult.sig <- subset(adult.up, qvals.state_bool < qval.threshold)
#82 observations, note there are some NAs
#na.omit

adult.sig <- subset(adult.up, qvals.state_bool.age_bool < qval.threshold)
